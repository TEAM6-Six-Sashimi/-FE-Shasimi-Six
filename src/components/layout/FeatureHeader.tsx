...
export default function FeatureHeader({
  ...
  return (
    <div className="w-full bg-[#F9FBE7] py-5 flex items-center justify-between">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start max-w-275 w-full mx-auto px-6 gap-1 sm:gap-0">
        <div>
        ...
        {right && (
          <p
            className={`text-[13px] font-medium whitespace-nowrap sm:pt-7.5 ${
