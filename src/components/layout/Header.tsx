...
export default function Header() {
    ...
    return (
        <div
            className="flex bg-white border-b border-[#E5E7EB] h-12 items-center p-5"
        >
            <Link href="/">
            ...
            {mockUser === null ? (
                <>
                    <div className="flex gap-2 items-center">
                        ...
                        <Link href="/auth/signup" className="bg-[#CFEE5D] hover:bg-[#A8D014] text-[15px] font-semibold h-8 w-21 flex items-center justify-center rounded-sm">
                            <div>회원가입</div>
                        </Link>
                    </div>
                </>
