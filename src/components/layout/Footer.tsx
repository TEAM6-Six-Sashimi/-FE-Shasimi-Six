        ...
        <div className="bg-[#1E2125] py-1 border-t border-[#E5E7EB]">
            <div className="max-w-7xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-10 pt-8 pb-8">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-1.5">
                        <Link href="/customer-service" className="text-[14px] text-[#E5E7EB] hover:text-[#D1D5DB]">
                            공지사항
                        </Link>
                        <Link href="/customer-service" className="text-[14px] text-[#E5E7EB] hover:text-[#D1D5DB]">
                            1:1 문의
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex flex-col gap-1.5">
                        <a href="https://github.com/TEAM6-Six-Sashimi"
                            target="_blank" className="text-[14px] text-[#E5E7EB] hover:text-[#D1D5DB]">
                            GitHub
                        </a>
                        <a href="https://www.figma.com/design/exzc72UCc2ZD4oMkvYK1UO/%EC%9C%A1%EC%82%AC%EC%8B%9C%EB%AF%B8%EC%A1%B0?node-id=0-1&t=ExjZtToaTpytkqle-1"
                            target="_blank" className="text-[14px] text-[#E5E7EB] hover:text-[#D1D5DB]">
                            Figma
                        </a>
                        <a href="https://www.notion.so/ohgiraffers/6-34c649136c11809fb109e8652d5982a1?source=copy_link"
                            target="_blank" className="text-[14px] text-[#E5E7EB] hover:text-[#D1D5DB]">
                            Team Notion
                        </a>
                    </div>
            ...
            <div className="flex max-w-[95%] mx-auto justify-between items-center pt-4 pb-4 border-t border-[#99A1AF]">
                <p className="text-[14px] text-[#99A1AF]">© 2026 온라인 강의 플랫폼 (주)핏격. All rights reserved.</p>
