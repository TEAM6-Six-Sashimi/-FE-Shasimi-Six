...
export const MOCK_COURSES: Course[] = [
  // ── ai (17개) ──
  { id: 1,  title: 'ChatGPT 완전정복 A to Z',              instructor: '김AI',   thumbnail: '/mock/course1.jpg',  rating: 4.9, reviewCount: 10234, price: 12900, duration: 24, level: '중급', category: 'ai', subCategory: 'ChatGPT 활용',      badge: '인기' },
  ...
  { id: 4,  title: 'ChatGPT로 콘텐츠 만들기',               instructor: '최콘텐', thumbnail: '/mock/course4.jpg',  rating: 4.6, reviewCount: 3210,  price: 8900,  duration: 15, level: '중급', category: 'ai', subCategory: 'ChatGPT 활용' },
  { id: 5,  title: 'ChatGPT API 개발 중급',                 instructor: '정개발', thumbnail: '/mock/course5.jpg',  rating: 4.7, reviewCount: 4321,  price: 14900, duration: 28, level: '중급', category: 'ai', subCategory: 'ChatGPT 활용',      badge: 'NEW' },
  ...
  { id: 7,  title: 'ChatGPT로 수익화하는 법',               instructor: '윤수익', thumbnail: '/mock/course7.jpg',  rating: 4.8, reviewCount: 8901,  price: 9900,  duration: 16, level: '중급', category: 'ai', subCategory: 'ChatGPT 활용',      badge: '인기' },
  ...
  { id: 11, title: '프롬프트 엔지니어링 기초',              instructor: '강프롬', thumbnail: '/mock/course11.jpg', rating: 4.6, reviewCount: 3210,  price: 9900,  duration: 18, level: '중급', category: 'ai', subCategory: '프롬프트 엔지니어링', badge: 'NEW' },
  ...
  { id: 14, title: '프롬프트로 이미지 생성하기',            instructor: '류이미', thumbnail: '/mock/course2.jpg',  rating: 4.5, reviewCount: 2345,  price: 8900,  duration: 15, level: '중급', category: 'ai', subCategory: '프롬프트 엔지니어링', badge: 'NEW' },
  ...
  { id: 22, title: '요가 기초부터 지도법까지',              instructor: '정지도', thumbnail: '/mock/course10.jpg', rating: 4.5, reviewCount: 2109,  price: 8900,  duration: 18, level: '중급', category: '건강 자격증', subCategory: '요가 지도사' },
  ...
  // ── 나머지 카테고리 ──
  { id: 35, title: '집에서 즐기는 홈쿠킹 클래스',          instructor: '김셰프', thumbnail: '/mock/course11.jpg', rating: 4.8, reviewCount: 7654,  price: 8900,  duration: 15, level: '중급', category: '라이프',    subCategory: '요리',       badge: 'NEW' },
  ...
  { id: 37, title: '왕초보 영어 말하기 30일 완성',          instructor: '김영어', thumbnail: '/mock/course1.jpg',  rating: 4.9, reviewCount: 12345, price: 12900, duration: 30, level: '중급', category: '외국어',    subCategory: '영어',       badge: '인기' },
  { id: 38, title: '주식 투자 중급 완전정복',               instructor: '김주식', thumbnail: '/mock/course2.jpg',  rating: 4.8, reviewCount: 9012,  price: 13900, duration: 22, level: '중급', category: '재테크',    subCategory: '주식',       badge: '인기' },
  { id: 39, title: '수채화 중급 드로잉 클래스',             instructor: '김화가', thumbnail: '/mock/course3.jpg',  rating: 4.8, reviewCount: 5432,  price: 9900,  duration: 18, level: '중급', category: '취미,문화', subCategory: '그림',       badge: 'NEW' },
];