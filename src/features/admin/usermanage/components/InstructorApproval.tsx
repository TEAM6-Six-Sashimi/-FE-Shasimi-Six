                ...
                >
                  ...
                  <td className="py-3 text-center">
                    <button
                      ...
                      className="px-3 py-1.5 rounded border-2 border-[#D1D5DB] text-[12px] font-semibold text-[#1E2125] bg-white hover:border-[#6A7282] cursor-pointer transition-colors disabled:opacity-50"
                    >
                      서류 확인
                    </button>
                  </td>
          ...
          >
            ...
            <div className="flex justify-end gap-2 mt-6">
              <button
                ...
                disabled={loading}
                className="px-5 py-2 rounded border-2 border-[#CFEE5D] text-[13px] font-semibold text-[#1E2125] bg-white hover:border-[#A8D014] hover:bg-[#F9FBE7] cursor-pointer transition-colors disabled:opacity-50"
              >
                승인
              </button>
              <button
