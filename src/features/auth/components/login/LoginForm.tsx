...
export default function LoginForm() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setErrorMessage(error.message || "서버와 연결할 수 없습니다. 백엔드 서버 연결 상태를 확인하세요.");
        } finally {
            setIsLoading(false);
        }
    };
    ...
    return (
        <form onSubmit={handleSubmit}>
            ...
            {errorMessage && (
                <div className="text-[14px] text-red-500 mb-4 font-medium pl-1">
                    ⚠ {errorMessage}
                </div>
            )}
            ...
            <button 
                ...
                // className="w-full py-3 text-[19px] rounded-lg bg-[#FF5F5F] hover:bg-[#D14848] text-white font-semibold cursor-pointer mb-2">
