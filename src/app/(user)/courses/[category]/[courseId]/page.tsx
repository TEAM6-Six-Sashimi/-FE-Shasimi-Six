...
const CARD = 'bg-white rounded-xl border border-[#E5E7EB] shadow-sm p-6';
...
export default function CourseDetailPage() {
  ...
  return (
    <div className="mx-[-var] min-h-screen bg-black px-4 py-8">
      <div className="flex gap-6 items-start">
        ...
        <div className="flex-1 flex flex-col gap-4 min-w-0">
          ...
          <div className={CARD + ' flex flex-col gap-4'}>
            {/* 썸네일 */}
            <div className="w-full aspect-video rounded-lg bg-[#E5E7EB] overflow-hidden" />
